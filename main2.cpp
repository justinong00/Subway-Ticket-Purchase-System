				...
				while (true) {
					...
					while (! goBack) {
						...
						if (selectNewStationLocationOpt == 1)			// Add As First Station
							...
							Menu::addSubHeader("Enter " + stationName + "'s Travel Distance To " + lst.getNodeAtIndex(lst.getSize())->data.currentStationName);
					...
					while (! goBack) {
						...
						// ! verified {New Station}'s Travel Distance To {Previous Station}
						cout << endl;
					...
					while (! goBack) {
						...
						cout << endl;
						// Enter {New Station}'s Travel Fare To {Previous Station}
					...
					while (! goBack) {
						...
						// ! verified {New Station}'s Travel Fare To {Previous Station}
						cout << endl;
					...
					while (! goBack) {
						...
						cout << endl;
						// Enter {New Station}'s Travel Time To {Previous Station}
					...
					while (! goBack) {
						...
						// ! verified {New Station}'s Travel Time To {Previous Station}
						cout << endl;
					...
					if (! goBack) {
						...
						// insert the new station details to doubly linked list
						...
						// update the corresponding data for the affected Previous Station
						...
						// update the corresponding data for the affected Next Station
						...
						else	// Go Back to Select A Location
							continue;
					}
					else	// if admin hit 0 (Go Back Previous -> abort) during SECOND: Enter Each Location
						continue;
				}
			}
		}	// comment here
